 ...
 */
    ...
    if (s.ok()) {
      ...
      for (int i = 0; i != num_cfs; ++i) {
        ...
        ROCKS_LOG_BUFFER(log_buffer, "[%s] Level summary: %s\n",
                         ...
                         cfds[i]->current()->storage_info()->LevelSummary(
                           &tmp));
      }
      if (made_progress) {
        *made_progress = true;
  ...
  void
  DBImpl::NotifyOnFlushBegin(ColumnFamilyData *cfd, FileMetaData *file_meta,
  ...
  Status DBImpl::CompactRange(const CompactRangeOptions &options,
    ...
    if (cfd->ioptions()->compaction_style == kCompactionStyleUniversal &&
      ...
      s = RunManualCompaction(cfd, ColumnFamilyData::kCompactAllLevels,
                              final_output_level, options, begin, end,
                              exclusive,
        ...
        if (cfd->ioptions()->compaction_style == kCompactionStyleUniversal ||
          ...
          if (
            (cfd->ioptions()->compaction_style == kCompactionStyleLevel
             ||
             cfd->ioptions()->compaction_style == kCompactionStyleQuickSand) &&
...
// before calling this function
  Status
  DBImpl::ReFitLevel(ColumnFamilyData *cfd, int level, int target_level) {
...
// background error or in normal processing.
  ...
  void DBImpl::BGWorkBottomCompaction(void *arg) {
    ...
    ca.db->BackgroundCallCompaction(prepicked_compaction,
                                    Env::Priority::BOTTOM);
    delete prepicked_compaction;
  }
  ...
  void
  DBImpl::BackgroundCallCompaction(PrepickedCompaction *prepicked_compaction,
